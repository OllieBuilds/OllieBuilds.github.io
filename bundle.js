...
/***/ function(module, exports, __webpack_require__) {
	...
	var gameplay = __webpack_require__(4);
...
/***/ function(module, exports, __webpack_require__) {
	...
	$('.square').on('click', function (event) {
	  ...
	  if (numTurn % 2 === 0) {
	    ...
	    var integer = $(this).attr('id').charAt(6);
	    var toNum = parseInt(integer);
	    index = toNum;
	    value = "X";
	    xArray.push(toNum);
	    console.log(xArray);
	    ...
	    $(this).addClass('unavailable');
	    // let id = $(this).attr('id');
	    var _integer = $(this).attr('id').charAt(6);
	    var _toNum = parseInt(_integer);
	    index = _toNum;
	    value = "O";
	    oArray.push(_toNum);
	    console.log(oArray);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var joinGame = function joinGame(success, failure) {
	...
	var updateGame = function updateGame(success, failure, index, value, gameover) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var signInTwoSuccess = function signInTwoSuccess(data) {
	  app.user2 = data.user;
	...
	module.exports = {
	  ...
	  signInTwoSuccess: signInTwoSuccess,
	  gameId: gameId
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	/* WEBPACK VAR INJECTION */(function(global) {module.exports = global["getFormFields"] = __webpack_require__(9);
	/* WEBPACK VAR INJECTION */}.call(exports, (function() { return this; }())))
